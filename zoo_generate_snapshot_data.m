...
%% Single pendulum with angle as the state
...
Arm_real = foo.Arm;
foo = load(['systems' , filesep , 'single-pend_1-mods_1-links_20hz' , filesep , 'single-pend_1-mods_1-links_20hz.mat']);
Arm_temp = foo.Arm;

% set parameters
saveon = true;  % save a datafile if this is true
num_snaps = 1000; % number of snapshots to generate
...
y_after = [ e_after , y_before_real , ureal ];
